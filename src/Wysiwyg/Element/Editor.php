<?php
namespace Mirasvit\Wysiwyg\Element;
    ...
    public function getElementHtml()
    {
        $html = $this->_getButtonsHtml() .
            '<textarea
                ...
                ' . $this->_getUiId() . '
                id="' . $this->getHtmlId() . '"' . '
                class="textarea mirasvit-editor' . $this->getClass() . '"
        ...
        $script = '
            <script type="text/javascript">
                require(["Mirasvit_Wysiwyg/js/editor"], function(editor) {
                editor.init("' . $this->getHtmlId() . '", ' . $config . ');
                });
            </script>
        ';
